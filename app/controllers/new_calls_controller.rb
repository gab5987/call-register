class NewCallsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @new_call.save
        format.html { redirect_to new_call_url(@new_call), notice: "Registro criado com sucesso." }
  ...
  def update
    respond_to do |format|
      if @new_call.update(new_call_params)
        format.html { redirect_to new_call_url(@new_call), notice: "Registro atualizado com sucesso." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to new_calls_url, notice: "Chamado apagado com sucesso." }
